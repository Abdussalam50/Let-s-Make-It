<?php
$tema = basename(__DIR__);
file_exists('../include/function/login.php') && include '../include/function/login.php';
$url = is_dir('../data/tmp/'.$tema.'/') ? '../data/tmp/'.$tema.'/' : '';
...
body {
    width: 100%;
    min-height: 100vh;
    background-image: linear-gradient(rgba(0,0,0,.5), rgba(0,0,0,.5)), url(<?php echo $url;?>1.jpg);
...
.button-container {
    display: flex;
    gap: 10px; /* Menambahkan jarak antar tombol, jika diperlukan */ 
}
.login__button {
    width: 60%;
    padding: 1rem;
