...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("data_detail_program");
} else {
    ...
    proses_action_cetak("data_detail_program");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Detail Program </th> h-->
                <th align="center" class="th_border cell"  >Nama Program </th>
                <th align="center" class="th_border cell"  >Nama User </th>
                <th align="center" class="th_border cell"  >Id Jenis Latihan </th>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_detail_program where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_detail_program where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_detail_program";
            }
            ...
            while ($data = mysql_fetch_array($proses)) {
                ...
                <tr class="event2">
                    ...
                    <!--h <td align="center"><?php echo $data['id_detail_program']; ?></td> h-->
                        ...
                        <td align="center"><?php echo baca_database("","id_jenis_latihan","select * from data_detail_latihan where id_detail_latihan='$data[id_detail_latihan]'")  ?></td>
