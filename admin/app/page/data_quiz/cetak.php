...
if (isset($_GET['input'])) {
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Quiz </th> h-->
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_quiz where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_quiz where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_quiz";
            }
