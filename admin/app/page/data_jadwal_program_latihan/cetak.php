...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("data_jadwal_program_latihan");
} else {
    ...
    proses_action_cetak("data_jadwal_program_latihan");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <center>
        <strong>LAPORAN
            ...
            <?php
            $tabelnya = "data_jadwal_program_latihan";
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Detail Program </th> h-->
                ...
                <th align="center" class="th_border cell"  >Hari Latihan </th>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_jadwal_program_latihan where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_jadwal_program_latihan where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_jadwal_program_latihan";
            }
