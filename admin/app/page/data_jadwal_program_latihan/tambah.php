                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>		
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                              <?php echo id_otomatis("data_jadwal_program_latihan", "id_jadwal_program", "10"); ?>  		
                            </td>
                        </tr>
                        h-->
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_jadwal_program_latihan", "id_jadwal_program", "10"); ?>" name="id_jadwal_program" placeholder="Id jadwal Program " id="id_jadwal_program" required="required">
                          ...
                          <tr>
                            <td width="25%" class="leftrowcms">
                                <label >Hari Latihan  <span class="highlight"></span></label>
                            </td>
                            <td width="2%">:</td>
                            <td>
                                <select class="form-control" style="width:50%" type="text" name="hari" id="hari" placeholder="Hari " required="required">
                                <option></option><?php combo_enum('data_jadwal_program_latihan','hari',''); ?>
                                </select>
                            </td>
                        </tr>
