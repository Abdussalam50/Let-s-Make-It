...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("data_artikel_tips");
} else {
    ...
    proses_action_cetak("data_artikel_tips");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Artikel Tips </th> h-->
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_artikel_tips where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_artikel_tips where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_artikel_tips";
            }
